<div align="center">
<img src="https://github.com/anonymousLLM/AgentKit/raw/main/AgentKit.png" width="350px">

**AgentKit: Flow Engineering with Graphs, not Coding**

ALL LINKS REMOVED FOR ANONYMITY
______________________________________________________________________
![](https://github.com/anonymousLLM/AgentKit/raw/main/teaser.png)
</div>

<img src="https://github.com/anonymousLLM/AgentKit/raw/main/AgentKit.png" width="65px"> offers a unified framework for explicitly constructing a complex human "thought process" from simple natural language prompts.
...
```bash
git clone https://github.com/anonymous && cd AgentKit
cd examples/prompt_without_coding
python generate_graph.py
```
![](https://github.com/anonymousLLM/AgentKit/raw/main/screenshot.png)

# Node Components

![](https://github.com/anonymousLLM/AgentKit/raw/main/node_archi.png)
